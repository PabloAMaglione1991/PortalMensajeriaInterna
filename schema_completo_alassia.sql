-- ============================================================================
-- ESQUEMA COMPLETO DE BASE DE DATOS MYSQL — HOSPITAL DR. ORLANDO ALASSIA
...
CREATE TABLE `paciente` (
  ...
  `fecha_nacimiento` DATE NULL COMMENT 'Fecha de nacimiento (fnac / fecha_nac)',
...
-- Datos Semilla de Prueba para base Central 'diagnose'
...
-- Tabla de Servicios Hospitalarios
...
-- Tabla de Usuarios / Profesionales de la Salud
...
CREATE TABLE `profesional` (
  ...
  CONSTRAINT `fk_profesional_servicio` FOREIGN KEY (`servicio_id`) REFERENCES `servicio` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish_ci;
...
CREATE TABLE `solicitud` (
  ...
  CONSTRAINT `fk_solicitud_origen` FOREIGN KEY (`servicio_origen_id`) REFERENCES `servicio` (`id`),
  CONSTRAINT `fk_solicitud_destino` FOREIGN KEY (`servicio_destino_id`) REFERENCES `servicio` (`id`),
  CONSTRAINT `fk_solicitud_solicitante` FOREIGN KEY (`profesional_solicitante_id`) REFERENCES `profesional` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish_ci;

-- Tabla de Alertas de Ausentismo (Despachadas a Servicio Social)
...
CREATE TABLE `ausentismo_alerta` (
  ...
  CONSTRAINT `fk_alerta_solicitud` FOREIGN KEY (`solicitud_id`) REFERENCES `solicitud` (`id`),
  CONSTRAINT `fk_alerta_servicio` FOREIGN KEY (`servicio_notificado_id`) REFERENCES `servicio` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish_ci;

-- Tabla de Auditoría Inmutable (Audit Trail)
...
-- Carga inicial de Servicios y Cuentas para el Portal Alassia
-- ----------------------------------------------------------------------------
